...
- Tested for mobile friendliness using https://search.google.com/search-console/mobile-friendly
- A11y test via http://www.evaluera.co.uk/atester
- Viewed on iOS, Android, Windows 10 desktop and laptop
- Validated via W3C validation service
- Refactoring
- QA and UAT pass by trained staff (husband)
